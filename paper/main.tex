...
grows with size, reaching $0.08\%$ over the strongest baseline and $2.6\%$ over
ReduMIS at one million vertices. Over the whole benchmark it is strictly ahead
...
against a single reference solver. In relative terms the margin over the
